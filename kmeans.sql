...
-- ----------------------------
INSERT INTO `tcentroid` VALUES (1, 11, 1, 0.6181, 0.0816, 0.8064);
INSERT INTO `tcentroid` VALUES (2, 15, 2, 0.0069, 0.0204, 0.8064);
INSERT INTO `tcentroid` VALUES (3, 19, 3, 0.0104, 0.0204, 0.0091);
...
-- Records of tdata
-- ----------------------------
INSERT INTO `tdata` VALUES (1, 'Danang Jadi Suroso', '-8.001467877016337, 110.94236324186754', 50000000.0000, 2.0000, 100000000.0000, '-8.001467877016337, 110.94236324186754', 'Peyek 1');
INSERT INTO `tdata` VALUES (2, 'Didik Darmadi', '-8.000869646143155, 110.94405324394953', 25000000.0000, 2.0000, 200000000.0000, '-8.000869646143155, 110.94405324394953', 'Tahu');
INSERT INTO `tdata` VALUES (3, 'Paimin Sugiarto', '-7.996078013095501, 110.94451458390513', 10000000.0000, 2.0000, 15000000.0000, '-7.996078013095501, 110.94451458390513', 'Tempe Kripik');
INSERT INTO `tdata` VALUES (4, 'Kelompok Tirto', '-7.996011609804214, 110.94433755810272', 3500000.0000, 20.0000, 7000000.0000, '-7.996011609804214, 110.94433755810272', 'Tempe Kripik');
INSERT INTO `tdata` VALUES (5, 'Candra', '-7.995267892178499, 110.94435096916085', 2500000.0000, 2.0000, 10000000.0000, '-7.995267892178499, 110.94435096916085', 'Tempe Kripik');
INSERT INTO `tdata` VALUES (6, 'Darmini', '-7.9902189789208995, 110.93834394550865', 2550000.0000, 2.0000, 8000000.0000, '-7.9902189789208995, 110.93834394550865', 'Tempe Kripik');
INSERT INTO `tdata` VALUES (7, 'Daryanto', '-7.989533686590662, 110.93750441409186', 9700000.0000, 1.0000, 15000000.0000, '-7.989533686590662, 110.93750441409186', 'Tempe Kripik');
INSERT INTO `tdata` VALUES (8, 'Suyati', '-8.001048128587708, 110.94041378403283', 10000000.0000, 50.0000, 25000000.0000, '-8.001048128587708, 110.94041378403283', 'Tempe Kripik');
INSERT INTO `tdata` VALUES (9, 'Heri Phutut Sugiarto', '-8.001558099284578, 110.93927384516027', 145000000.0000, 3.0000, 445000000.0000, '-8.001558099284578, 110.93927384516027', 'Peyek');
INSERT INTO `tdata` VALUES (10, 'Agus Sartono', '-8.000870169905374, 110.93699664969756', 5000000.0000, 2.0000, 20000000.0000, '-8.000870169905374, 110.93699664969756', 'Rambak');
INSERT INTO `tdata` VALUES (11, 'Danang Anggoro', '-7.985997869092734, 110.91997887225902', 5000000.0000, 2.0000, 20000000.0000, '-7.985997869092734, 110.91997887225902', 'Karak');
INSERT INTO `tdata` VALUES (12, 'Wahyono', '-7.986115387187872, 110.91906827247006', 7000000.0000, 1.0000, 120000000.0000, '-7.986115387187872, 110.91906827247006', 'Karak');
INSERT INTO `tdata` VALUES (13, 'Joko Sumanto', '-7.986436048067815, 110.92024585680441', 30000000.0000, 2.0000, 38000000.0000, '-7.986436048067815, 110.92024585680441', 'Karak');
INSERT INTO `tdata` VALUES (14, 'Edy Suryanto', '-7.987159860352496, 110.91823151782899', 90000000.0000, 5.0000, 360000000.0000, '-7.987159860352496, 110.91823151782899', 'Karak');
INSERT INTO `tdata` VALUES (15, 'Agus Kuncoro', '-7.986574170146446, 110.91843000131381', 25000000.0000, 1.0000, 200000000.0000, '-7.986574170146446, 110.91843000131381', 'Karak');
INSERT INTO `tdata` VALUES (16, 'Widi Murjito', '-7.985659956625658, 110.91724347711232', 75000000.0000, 1.0000, 300000000.0000, '-7.985659956625658, 110.91724347711232', 'Karak');
INSERT INTO `tdata` VALUES (17, 'Sayem', '-7.9850019386242845, 110.91738393307814', 8500000.0000, 2.0000, 12000000.0000, '-7.9850019386242845, 110.91738393307814', 'Rengginang');
INSERT INTO `tdata` VALUES (18, 'Slamet', '-7.984168982894617, 110.918084085619', 1000000.0000, 1.0000, 6000000.0000, '-7.984168982894617, 110.918084085619', 'Rengginang');
INSERT INTO `tdata` VALUES (19, 'Sukiman', '-7.985273856541108, 110.91912503546054', 2000000.0000, 2.0000, 360000000.0000, '-7.985273856541108, 110.91912503546054', 'Rengginang');
...
-- Records of thasil
-- ----------------------------
INSERT INTO `thasil` VALUES (1, 1, 'C3', 2);
INSERT INTO `thasil` VALUES (2, 2, 'C2', 2);
INSERT INTO `thasil` VALUES (3, 3, 'C3', 2);
INSERT INTO `thasil` VALUES (4, 4, 'C3', 2);
INSERT INTO `thasil` VALUES (5, 5, 'C3', 2);
INSERT INTO `thasil` VALUES (6, 6, 'C3', 2);
INSERT INTO `thasil` VALUES (7, 7, 'C3', 2);
INSERT INTO `thasil` VALUES (8, 8, 'C3', 2);
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_normalisasidata` AS SELECT 
	...
	((((a.Asset-(SELECT MIN(Asset) FROM tdata)))/((SELECT MAX(Asset) FROM tdata)-(SELECT MIN(Asset) FROM tdata)))) ND_Asset,
